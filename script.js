const apikey = 'ede68fb6-e880-40ad-91f7-62385ad907ab';
const apihost = 'https://todo-api.coderslab.pl';

if(apikey == '') {
  alert('Go to https://todo-api.coderslab.pl/apikey/create and copy the token and paste it into the constant "apikey", in the script.js file');
}
...
function apiListAllTasks() {
  return fetch(
    ...
    function (resp) {
      if(!resp.ok) {
        alert('Error! Open devtools and the Network / Network tab, and look for the cause');
      }
      return resp.json();
    }
  );
